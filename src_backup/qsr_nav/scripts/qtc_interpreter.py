...
class qtc_interpreter:
    def __init__(self):
        ...
        self.relationship_pub = rospy.Publisher("qtcb_realtionship", QsrMsg, queue_size = 5)
    ...
    def relations_callback(self,extracted_pose1,extracted_pose2):
        ...
        if (extracted_pose1.pose_vec.position.x < 0):
            qtc_relation_msg.marker_left = extracted_pose1.marker_id
            qtc_relation_msg.marker_right = extracted_pose2.marker_id

        else:
            qtc_relation_msg.marker_left = extracted_pose2.marker_id
            qtc_relation_msg.marker_right = extracted_pose1.marker_id
        ...
        for time in qsrlib_response_message.qsrs.get_sorted_timestamps():
            ...
            for key, value in zip(qsrlib_response_message.qsrs.trace[time].qsrs.keys(),
                            ...
                            qtc_relation_msg.objects = key
                            qtc_relation_msg.relationship = str(value.qsr)
