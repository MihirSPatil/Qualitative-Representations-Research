...
%\subsubsection*{Starting from a position along the center of the corridor}
...
%\subsubsection*{Starting from a position along the right wall of the corridor}
\begin{sidewaysfigure}[h!]
...
%\subsubsection*{Starting from a position along the left wall of the corridor}
\begin{sidewaysfigure}[h!]
...
%When performing the experiments the most common issue faced was the quick discharge of the battery and the loss of communication between the modules and the remote computer.
